...
// import 'api/models/coin_response.dart';
// import 'api/models/get_all_coins_response.dart';

// class WalletDatasource {
//   final GenckoEndpoints dio;

//   WalletDatasource(this.dio);

//   Future<List<CoinViewData>> getCoinsWallet() async {
//     Future<GetAllCoinsResponse> getCoins() async {
//       final response = await dio.getCoinsWallet([
//         "ethereum",
//         "bitcoin",
//         "ethereum",
//       ], 'brl');
//       return GetAllCoinsResponse(
//           List.from(response.data.map((coin) => CoinResponse.fromJson(coin))));
//     }

//     Future<List<CoinViewData>> getAllCoins(String vScurrency) async {
//       List<CoinViewData> list = [];
//       final response = await getCoins();

//       return response.toViewData();
//     }

//     return getAllCoins('brl');
